  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl text-foreground">Không tìm thấy trang</h2>
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-sm border border-input bg-background px-5 py-2.5 text-sm text-foreground transition-colors hover:bg-card"
          >
            Về trang chủ
          </a>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Gốm Bàu Trúc — Nghệ Nhân Đàng Xem" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Gốm Bàu Trúc — Đàng Xem" },
